      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between px-6 py-4">
        ...
        <div className="flex items-center bg-white rounded-full shadow-[0px_4px_12px_rgba(0,0,0,0.1)] overflow-hidden flex-1 max-w-4xl border border-gray-200">
          <div className="px-6 py-3 border-r border-gray-300">
            <p className="text-xs text-[#717171] font-medium">Lugar</p>
            <p className="text-sm text-[#222222]">Explorar destinos</p>
          </div>
          <div className="px-6 py-3 border-r border-gray-300">
          ...
          <button className="bg-[#FF385C] hover:bg-[#e03151] text-white p-3 rounded-full m-2 transition">
            <SearchIcon />
          </button>
        </div>
